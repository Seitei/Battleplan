...
package starling.display
{
	...
	public class Button extends DisplayObjectContainer
	{
		...
		public function Button(upState:Texture, text:String="", downState:Texture=null, hoverState:Texture=null, textDown:TextField = null)
		{
			if (upState == null) throw new ArgumentError("Texture cannot be null");
			
			mUpState = upState;
			mDownState = downState ? downState : upState;
			mHoverState = hoverState ? hoverState : downState;
			mTextDown = textDown;
